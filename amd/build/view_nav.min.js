define("block_new_myoverview/view_nav", [
  "exports",
  "jquery",
  "core/custom_interaction_events",
  "block_myoverview/repository",
  "block_new_myoverview/view",
  "block_myoverview/selectors",
], function (_exports, _jquery, CustomEvents, Repository, View, _selectors) {
   ...
   */ Object.defineProperty(_exports, "__esModule", { value: !0 }),
    ...
    (View = _interopRequireWildcard(View)),
    ...
    ((root) => {
      ...
      CustomEvents.define(Selector, [CustomEvents.events.activate]),
        Selector.on(
          ...
          _selectors.default.FILTER_OPTION,
          (e, data) => {
            ...
            if ("" !== input.value) {
              const clearIcon = page.querySelector(
                _selectors.default.region.clearIcon
              );
        ...
        Selector.on(
          CustomEvents.events.activate,
          _selectors.default.DISPLAY_OPTION,
          (e, data) => {
            const option = (0, _jquery.default)(e.target);
            if (option.hasClass("active")) return;
            ...
            root
              .find(_selectors.default.courseView.region)
              .attr("data-display", option.attr("data-value")),
              updatePreferences(filter, pref),
              View.reset(root),
              data.originalEvent.preventDefault();
          }
